...
rightclone.Name = "RightUpperShoulder"
...
leftclone.Name = "LeftUpperShoulder"
...
leftlegclone.Name = "LeftUpperHip"
...
rightlegclone.Name = "RightUpperHip"
...
function R6ragdollJoint(character,limbname,attached,heded)
	pcall(function()
		...
		if limbname == "RightUpperArm" and character:FindFirstChild("RightUpperArm") and character:FindFirstChild("UpperUpperTorso") and character.UpperTorso:FindFirstChild("RightUpperArmRagdollConstraint") == nil and character[limbname]:FindFirstChild("RightUpperArmRagdollConstraint") == nil then
			local torsoatt = Instance.new('Attachment',character.UpperUpperTorso)
			...
			if character.UpperUpperTorso:FindFirstChild('RightUpperShoulder') then
				character.UpperUpperTorso:FindFirstChild('RightUpperShoulder'):Destroy()
			end
		elseif limbname == "LeftUpperArm" and character:FindFirstChild("LeftUpperArm") and character:FindFirstChild("UpperTorso") and character.UpperTorso:FindFirstChild("LeftUpperArmRagdollConstraint") == nil and character[limbname]:FindFirstChild("LeftUpperArmRagdollConstraint") == nil then
			local torsoatt = Instance.new('Attachment',character.UpperTorso)
			torsoatt.Name = limbname.."RagdollConstraint"
			torsoatt.Position = Vector3.new(-1.45,0.768,-0.009)
			torsoatt.Axis = Vector3.new(1,0,0)
			torsoatt.SecondaryAxis = Vector3.new(0,1,0)
			...
			if character.UpperTorso:FindFirstChild('LeftUpperShoulder') then
				character.UpperTorso:FindFirstChild('LeftUpperShoulder'):Destroy()
			end
		elseif limbname == "RightUpperLeg" and character:FindFirstChild("RightUpperLeg") and character:FindFirstChild("UpperTorso") and character.UpperTorso:FindFirstChild("RightUpperLegRagdollConstraint") == nil and character[limbname]:FindFirstChild("RightUpperLegRagdollConstraint") == nil then
			stun(character)
			local torsoatt = Instance.new('Attachment',character.UpperTorso)
			torsoatt.Name = limbname.."RagdollConstraint"
			...
			if character.UpperTorso:FindFirstChild('RightUpperHip') then
				character.UpperTorso:FindFirstChild('RightUpperHip'):Destroy()
			end
		elseif limbname == "LeftUpperLeg" and character:FindFirstChild("LeftUpperLeg") and character:FindFirstChild("UpperTorso") and character.UpperTorso:FindFirstChild("LeftUpperLegRagdollConstraint") == nil and character[limbname]:FindFirstChild("LeftUpperLegRagdollConstraint") == nil then
			stun(character)
			local torsoatt = Instance.new('Attachment',character.UpperTorso)
			torsoatt.Name = limbname.."RagdollConstraint"
			torsoatt.Position = Vector3.new(-0.45, -1.242, -0.009)
			...
			if character.UpperTorso:FindFirstChild('LeftUpperHip') then
				character.UpperTorso:FindFirstChild('LeftUpperHip'):Destroy()
			end
		elseif limbname == "Head" or limbname == "UpperTorso" and character:FindFirstChild("Head") and character:FindFirstChild("UpperTorso") and character.Head:FindFirstChild("Neck") == nil then
			...
			if character.UpperTorso:FindFirstChild('Neck') then
				character.UpperTorso.Neck:Destroy()
			end
			if character:FindFirstChild('UpperTorso') then
				local collidepart = Instance.new('Part',character.UpperTorso)
				collidepart.Size = character.UpperTorso.Size/1.5
				collidepart.CanCollide = true
				collidepart.Name = "Collision"
				collidepart.Anchored = false
				collidepart.Transparency = 1
				collidepart.CFrame = character.UpperTorso.CFrame
				collidepart:BreakJoints()
			...
			if character:FindFirstChild('UpperTorso') and character:FindFirstChild('Head') then
				if character.UpperTorso:FindFirstChild('NeckAttachment') == nil then
					local neck = Instance.new('Attachment',character.UpperTorso)
					neck.Name = "NeckAttachment"
					neck.Position = Vector3.new(0, 1, 0)
				end
				ragdollJoint(character,character.UpperTorso, character.Head, "NeckAttachment", "Hinge", {
					{"LimitsEnabled",true};
					{"UpperAngle",50};
					{"LowerAngle",-50};
				})
			...
			if attached ~= false then
				ragdollpart(character, "RightUpperLeg")
				ragdollpart(character, "LeftUpperLeg")
			else
				pcall(function()
					local ayybleed = Instance.new('Part',character)
					ayybleed.Size = Vector3.new(character.UpperTorso.Size.X,0.1,character.UpperTorso.Size.Z)
			...
			ragdollpart(character, "RightUpperArm")
			ragdollpart(character, "LeftUpperArm")
		end
	end)
end
...
function ragdollpart(character,partname,attached,heded)
	if heded ~= false then
		...
		local thing = "UpperTorso"
		if character:FindFirstChild(thing) == nil then
			thing = "UpperUpperTorso"
		end
		pcall(function()
	...
	if partname == "HumanoidRootPart" then
		if character:FindFirstChild('UpperTorso') then
			...
			partname = "UpperUpperTorso"
		end
	end
	if attached == false then
		if character:FindFirstChild('UpperUpperTorso') then
			pcall(function()
				character.UpperUpperTorso.WaistRigAttachment:Destroy()
			end)
			pcall(function()
				local ayybleed = Instance.new('Part',character)
				ayybleed.Size = Vector3.new(character.UpperUpperTorso.Size.X,0,character.UpperUpperTorso.Size.Z)
				ayybleed.Transparency = 1
				ayybleed.CanCollide = false
				ayybleed.CFrame = character.UpperUpperTorso.CFrame
				ayybleed:BreakJoints()
				ayybleed.Name = "ayybleed"
				local attachment1 = Instance.new('Attachment',ayybleed)
				attachment1.Position = Vector3.new(0,-character.UpperUpperTorso.Size.Y/2,0)
				attachment1.Orientation = Vector3.new(0,0,180)
				local attachment0 = Instance.new('Attachment',character.UpperUpperTorso)
				if attachment0 and attachment1 then
					local constraint = Instance.new("HingeConstraint")
					constraint.Attachment0 = attachment0
					constraint.Attachment1 = attachment1
			...
			pcall(function()
				local ayybleed = Instance.new('Part',character)
				ayybleed.Size = Vector3.new(character.LowerUpperTorso.Size.X-0.1,0.1,character.LowerUpperTorso.Size.Z-0.1)
				ayybleed.Transparency = 1
				ayybleed.CanCollide = false
				ayybleed.CFrame = character.LowerUpperTorso.CFrame
				ayybleed:BreakJoints()
				ayybleed.Name = "ayybleed"
				local attachment1 = Instance.new('Attachment',ayybleed)
				attachment1.Position = Vector3.new(0,-character.LowerUpperTorso.Size.Y/2,0)
				attachment1.Orientation = Vector3.new(0,0,0)
				local attachment0 = Instance.new('Attachment',character.LowerUpperTorso)
				if attachment0 and attachment1 then
					local constraint = Instance.new("HingeConstraint")
					constraint.Attachment0 = attachment0
					constraint.Attachment1 = attachment1
		...
		pcall(function()
			local thang = "UpperTorso"
			if character:FindFirstChild('UpperUpperTorso') then
				thang = "UpperUpperTorso"
			end
			local ayybleed = Instance.new('Part',character)
		...
		pcall(function()
			local ree = character.LowerUpperTorso
			local thang = "LowerUpperTorso"
			local ayybleed = Instance.new('Part',character)
			ayybleed.Size = Vector3.new(character[thang].Size.X-0.1,0.1,character[thang].Size.Z-0.1)
			ayybleed.Color = Frame_2.BackgroundColor3
			ayybleed.Material = Enum.Material.SmoothPlastic
		...
		pcall(function()
			local ree = character["RightUpperLeg"]
			local thang = "RightUpperLeg"
			local ayybleed = Instance.new('Part',character)
			ayybleed.Size = Vector3.new(character[thang].Size.X-0.1,0.1,character[thang].Size.Z-0.1)
			ayybleed.Color = Frame_2.BackgroundColor3
			ayybleed.Material = Enum.Material.SmoothPlastic
		...
		pcall(function()
			local ree = character["LeftUpperLeg"]
			local thang = "LeftUpperLeg"
			local ayybleed = Instance.new('Part',character)
			ayybleed.Size = Vector3.new(character[thang].Size.X-0.1,0.1,character[thang].Size.Z-0.1)
			ayybleed.Color = Frame_2.BackgroundColor3
			ayybleed.Material = Enum.Material.SmoothPlastic
	...
	if partname == "RightHand" or partname == "RightLowerArm" or partname == "RightUpperArm" then
		...
		if character:FindFirstChild('UpperUpperTorso') and character:FindFirstChild('RightUpperArm') then
			ragdollJoint(character, character.UpperUpperTorso, character["RightUpperArm"], "RightShoulder", "BallSocket")
		end
	...
	elseif partname == "LeftHand" or partname == "LeftLowerArm" or partname == "LeftUpperArm" then
		...
		if character:FindFirstChild('UpperUpperTorso') and character:FindFirstChild('LeftUpperArm') then
			ragdollJoint(character, character.UpperUpperTorso, character["LeftUpperArm"], "LeftShoulder", "BallSocket")
		end
	...
	elseif partname == "RightFoot" or partname == "RightUpperLeg" or partname == "RightLowerLeg" then
		...
		if character:FindFirstChild('LowerUpperTorso') and character:FindFirstChild('RightUpperLeg') then
			ragdollJoint(character,character.LowerUpperTorso, character.RightUpperLeg, "RightHip", "BallSocket")
		end
	elseif partname == "LeftFoot" or partname == "LeftUpperLeg" or partname == "LeftLowerLeg" then
		...
		if character:FindFirstChild('LowerUpperTorso') and character:FindFirstChild('LeftUpperLeg') then
			ragdollJoint(character,character.LowerUpperTorso, character.LeftUpperLeg, "LeftHip", "BallSocket")
		end
	elseif partname == "Head" or partname == "UpperUpperTorso" or partname == "LowerUpperTorso" then
		if character:FindFirstChildOfClass('Humanoid') and character:FindFirstChildOfClass('Humanoid').RigType == Enum.HumanoidRigType.R15 then
			...
			if heded == false then
				pcall(function()
					...
					character.UpperUpperTorso:FindFirstChild('NeckAttachment'):Destroy()
				end)
			end
			if character:FindFirstChild('UpperUpperTorso') and character:FindFirstChild('LowerUpperTorso') then
				ragdollJoint(character,character.LowerUpperTorso, character.UpperUpperTorso, "Waist", "BallSocket", {
					{"LimitsEnabled",true};
					{"UpperAngle",5};
					{"Radius",5};
				})
			end
			if character:FindFirstChild('UpperUpperTorso') and character:FindFirstChild('Head') then
				ragdollJoint(character,character.UpperUpperTorso, character.Head, "Neck", "Hinge", {
					{"LimitsEnabled",true};
					{"UpperAngle",50};
					{"LowerAngle",-50};
				})
...
function spawned()
	...
	local hweld = Instance.new("Weld", char.UpperTorso)
	hweld.Part0 = char.UpperTorso
	hweld.Part1 = handle
	...
	function oogabooga()
		if rdd == false then
			...
			pcall(function()
				...
				ra.Parent = char.UpperTorso
				ra.Part0 = char.UpperTorso
				ra.Part1 = char["RightUpperArm"]
			end)
			pcall(function()
				local la = leftclone:Clone()
				la.Parent = char.UpperTorso
				la.Part0 = char.UpperTorso
				la.Part1 = char["LeftUpperArm"]
			end)
			pcall(function()
				local ll = leftlegclone:Clone()
				ll.Parent = char.UpperTorso
				ll.Part0 = char.UpperTorso
				ll.Part1 = char["LeftUpperLeg"]
			end)
			pcall(function()
				local rl = rightlegclone:Clone()
				rl.Parent = char.UpperTorso
				rl.Part0 = char.UpperTorso
				rl.Part1 = char["RightUpperLeg"]
			end)
		end
	end
	function getrid()
	...
	function equip()
		equipped = true
		working = true
		if char.UpperTorso:FindFirstChild("RightUpperShoulder") then
			char.UpperTorso:FindFirstChild("RightUpperShoulder"):Destroy()
		end
		local weld = Instance.new('Weld', char.UpperTorso)
		weld.Name = "Lerping"
		...
		hweld.Part0 = char["RightUpperArm"]
		...
		weld:Destroy()
		if rightclone and char:FindFirstChild('RightUpperArm') and char:FindFirstChild('UpperTorso') then
			local clone = rightclone:Clone()
			clone.Part0 = char.UpperTorso
			clone.Part1 = char["RightUpperArm"]
	...
	function raep()
		...
		waitwhatthefuck.Volume = 0.5
			...
			tweld.Part1 = char.UpperTorso
			local rweld = Instance.new("Weld", char["RightUpperArm"])
			rweld.Part0 = char["UpperTorso"]
			rweld.Part1 = char["RightUpperArm"]
			rweld.C0 = CFrame.new(1.5, 0, 0)
			local lweld = Instance.new("Weld", char["LeftUpperArm"])
			lweld.Part0 = char.UpperTorso
			lweld.Part1 = char["LeftUpperArm"]
			...
			if aidsificating == nil then
				...
				if torsoclone and char:FindFirstChild("UpperTorso") and char:FindFirstChild("HumanoidRootPart") then
					local clone = torsoclone:Clone()
					clone.Part0 = char.HumanoidRootPart
					clone.Part1 = char.UpperTorso
					clone.Parent = char.HumanoidRootPart
				end
				if leftclone and char:FindFirstChild('LeftUpperArm') and char:FindFirstChild('UpperTorso') then
					local clone = leftclone:Clone()
					clone.Part0 = char.UpperTorso
					clone.Part1 = char["LeftUpperArm"]
					clone.Parent = char.UpperTorso
				end
				if rightclone and char:FindFirstChild('RightUpperArm') and char:FindFirstChild('UpperTorso') then
					local clone = rightclone:Clone()
				...
				pcall(function()
					local weld = Instance.new('Weld',aidsificating.UpperUpperTorso)
					weld.Part0 = aidsificating.UpperUpperTorso
					weld.Part1 = handle
					weld.C0 = CFrame.new(0.2,-2.5,2)*CFrame.Angles(math.rad(135),0,math.rad(-90))
					for i,v in pairs(handle["pink toy"]:GetChildren()) do
						if v:IsA('BasePart') and v.Name == "stretchlol" then
							v.BrickColor = aidsificating.UpperUpperTorso.BrickColor
							v.Transparency = 0
						end
					end
				end)
				...
				pcall(function()
					local thang = "UpperTorso"
					if aidsificating:FindFirstChild('UpperUpperTorso') then
						thang = "UpperUpperTorso"
					end
	...
	function katanaQ()
		...
		pcall(function()
			...
			if goteem then
				wait(2)
				pcall(function()
					local sounn = Instance.new("Sound", goteem.UpperTorso)
	...
	function throw()
		working = true
		pcall(function()
			local rweld = char["RightUpperArm"]:FindFirstChild("Weld")
			local lweld = char["LeftUpperArm"]:FindFirstChild("Weld")
			local tweld = Instance.new("Weld", char.HumanoidRootPart)
			tweld.Part0 = char.HumanoidRootPart
			tweld.Part1 = char.UpperTorso
			...
			pcall(function()
				throwvel.Parent = grabbed.UpperUpperTorso
			end)
					...
					if touched == false then
						if hit and hit.Parent and hit.Transparency ~= 1 and hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent~= char then
							...
							pcall(function()
								...
								bleedBLEED()
								if hit.Name ~= "Head" and hit.Name ~= "UpperUpperTorso" and hit.Name ~= "UpperTorso" and hit.Name ~= "LowerUpperTorso" then
							...
							if hit.Name == "Head" or hit.Name == "UpperUpperTorso" or hit.Name == "UpperTorso" or hit.Name == "LowerUpperTorso" then
								pcall(function()
	...
	function kill()
		...
		pcall(function()
			...
			pcall(function()
				attachment0.Parent = grabbed.UpperUpperTorso
			end)
			if attachment0 and attachment1 then
				local constraint = Instance.new("HingeConstraint")
				constraint.Attachment0 = attachment0
				...
				pcall(function()
					constraint.Parent = grabbed.UpperUpperTorso
				end)
			end
			local bleedBLEED= coroutine.wrap(function()
				bleed(ayybleed)
	...
	function release()
		...
		pcall(function()
			...
			grabbed = nil
			grabweld:Destroy()
			removewelds(char["RightUpperArm"])
			removewelds(char["LeftUpperArm"])
			local rweld = Instance.new("Weld", char["RightUpperArm"])
			local lweld = Instance.new("Weld", char["LeftUpperArm"])
			rweld.Part0 = char["UpperTorso"]
			rweld.Part1 = char["RightUpperArm"]
						...
						if gettingeem then
							if goteem == nil then
								if hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent:FindFirstChildOfClass('Humanoid').Health > 0 and hit.Parent ~= char then
									local sounn = Instance.new("Sound", char.UpperTorso)
									local lipp = math.random(1, 3)
									if lipp == 1 then sounn.SoundId = "rbxassetid://444667844" end
									if lipp == 2 then sounn.SoundId = "rbxassetid://444667824" end
									if lipp == 3 then sounn.SoundId = "rbxassetid://444667859" end
									...
									pcall(function()
										local weld = Instance.new('Weld',goteem.UpperUpperTorso)
										weld.Part0 = goteem.UpperUpperTorso
										weld.Part1 = handle
										weld.C0 = CFrame.new(0,0,2)*CFrame.Angles(math.rad(90),0,math.rad(-90))
									end)
									pcall(function()
										local thang = "UpperTorso"
										if goteem:FindFirstChild('UpperUpperTorso') then
											thang = "UpperUpperTorso"
										end
					...
					elseif blademode == "knife" then
						if grabbing == true and grabbed == nil then
							if hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent:FindFirstChildOfClass('Humanoid').Health > 0 and hit.Parent ~= char then
								...
								local grabwelds = Instance.new("Weld", char.UpperTorso)
								grabwelds.Part0 = char.UpperTorso
								pcall(function()
									grabwelds.Part1 = grabbed.UpperTorso
								end)
								pcall(function()
									grabwelds.Part1 = grabbed.UpperUpperTorso
								end)
...
function removeR6Motors(model)
    for _,v in pairs(model:GetDescendants()) do
        if v:IsA("Motor6D") and (v.Name == "RightUpperShoulder" or v.Name == "LeftUpperShoulder" or v.Name == "RightUpperHip" or v.Name == "LeftUpperHip" or v.Name == "RootJoint") then
            v:Destroy()
        end
    end
end
removeR6Motors(game.Players.LocalPlayer.Character)

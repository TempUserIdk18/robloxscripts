...
local function teleportBehindPlayer(targetPlayer)
    ...
    -- First teleport 1.3 studs behind
    local offset1 = targetCFrame.LookVector * -1.3
    local newPosition1 = targetCFrame.Position + offset1
    localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(newPosition1, targetCFrame.Position)

    -- Wait 0.5 seconds, then teleport 2 studs behind
    task.delay(0.5, function()
        if localPlayer.Character and localPlayer.Character:FindFirstChild("HumanoidRootPart") then
            local offset2 = targetCFrame.LookVector * -3
            local newPosition2 = targetCFrame.Position + offset2
            localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(newPosition2, targetCFrame.Position)
        end
    end)
	wait(0.35)
end
